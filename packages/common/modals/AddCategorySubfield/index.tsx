...
const AddCategorySubfield = ({ loading, onSave }: { loading: boolean; onSave: (updateType: ETransactionFieldsUpdateType, fieldName: string, fieldDesc: string, subfields?: ITransactionCategorySubfields, onCancel?: () => void) => Promise<void> }) => {
  ...
  return (
    <div>
        ...
        <Modal
            ...
            title='Add Sub-Field'
        >
            <AddCategorySubfieldForm loading={loading} onSave={onSave} onCancel={() => setOpenModal(false)} />
        </Modal>
